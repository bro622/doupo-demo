...
EXPORTS = [
    (
        ...
        DOWNLOADS / f"doupo-demo-{RELEASE_VERSION}.exe",
    ),
    (
        "Android",
        PROJECT / "Android" / "斗破苍穹·斗帝之路 - Demo.apk",
        DOWNLOADS / f"doupo-demo-{RELEASE_VERSION}.apk",
    ),
    (
        "macOS",
        PROJECT / "macOS" / "斗破苍穹·斗帝之路 - Demo.zip",
        DOWNLOADS / f"doupo-demo-{RELEASE_VERSION}-macos.zip",
    ),
]
